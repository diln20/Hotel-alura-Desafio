...
public class RegistroHuesped extends JFrame {
	...
	int xMouse, yMouse;
        private HuespedVO huespedVO=new HuespedVO();
        private FachadaHotel fachadHotel = new FachadaHotel();
        
        
        private int idReserva;

        public void setVariablePasada(int idReserva) {
	...
	public RegistroHuesped() {
		...
		String selectedField = (String) txtNacionalidad.getSelectedItem();
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
                            ...
                            Calendar FechaNacimiento = txtFechaN.getCalendar();
                            
                            huespedVO.setNombre(txtNombre.getText());
                            huespedVO.setApellido(txtApellido.getText());
                            huespedVO.setFechaNacimiento(FechaNacimiento.toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
                                
                            huespedVO.setIdReserva(idReserva);
                            
                            huespedVO.setNacionalidad(selectedField);
                            huespedVO.setTelefono(txtTelefono.getText());
                            
                            boolean valido=fachadHotel.guardar(huespedVO,idReserva);
                            System.out.println("valido"+valido);
                            if (valido) {
                                dispose();
                                Exito exito=new Exito();
                                exito.setVisible(valido);
                            }

    ...
    public MenuUsuario() {
        ...
        btnLogout.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                String log=(String)UserSession.getLoggedInUser();
                System.out.println(""+log);
                System.out.println("lif" + login.getIsAuthenticated());
                dispose();
            }
        });
        ...
        lblCerrarSesion.setForeground(SystemColor.text);
        lblCerrarSesion.setBounds(25, 11, 205, 34);
        lblCerrarSesion.setFont(new Font("Roboto", Font.PLAIN, 18));
        lblCerrarSesion.setHorizontalAlignment(SwingConstants.LEFT);
        btnLogout.add(lblCerrarSesion);
    }

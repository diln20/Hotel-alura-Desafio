...
public class Login extends JFrame {
    ...
    private void Login() {
        ...
        usuariov.setUsuario(txtUsuario.getText());
        usuariov.setPassword(contrase);
        boolean verificar = fachadaHotel.verificarUsuario(usuariov);
        System.out.println("usuario encontrado: " + verificar);
        // if(txtUsuario.getText().equals(Usuario) && contrase.equals(Contraseña)){
        if (verificar) {
            UserSession.setLoggedInUser(txtUsuario.getText());

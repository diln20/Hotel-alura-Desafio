...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        ReservasVO reservaVO = new ReservasVO();
        ...
        String selectedField = (String) txtFormaPago.getSelectedItem();
        reservaVO.setFormaPago(selectedField);
        ...
        btnsiguiente.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
                    ...
                    int idReserva = fachadHotel.guardar(reservaVO);

                    RegistroHuesped registro = new RegistroHuesped();
                    registro.setVariablePasada(idReserva);
